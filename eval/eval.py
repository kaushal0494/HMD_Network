...
def eval(hyp, ref):
    ...
    print("[BLEU =>> B1: {:.2f}, B2: {:.2f}, B3: {:.2f}, B4: {:.2f}] [ROUGE_L =>> {:.2f}] [METEOR =>> {:.2f}]".format(
        eval1[0], eval1[1], eval1[2], eval1[3], eval1[4], eval1[5]
    ))
    ...
    print("[BLEU =>> B1: {:.2f}, B2: {:.2f}, B3: {:.2f}, B4: {:.2f}] [ROUGE_L =>> {:.2f}] [METEOR =>> {:.2f}]".format(
        eval2[0], eval2[1], eval2[2], eval2[3], eval2[4], eval2[5]
    ))
    ...
    print("[BLEU =>> B1: {:.2f}, B2: {:.2f}, B3: {:.2f}, B4: {:.2f}] [ROUGE_L =>> {:.2f}] [METEOR =>> {:.2f}]".format(
        eval3[0], eval3[1], eval3[2], eval3[3], eval3[4], eval3[5]
    ))
