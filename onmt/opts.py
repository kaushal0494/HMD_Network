...
def model_opts(parser):
    ...
    group.add_argument('-word_encoder_type', type=str, default='brnn',
                       choices=['rnn', 'brnn', 'mean', 'transformer', 'cnn'],
                       help="""hierarchical layer word encode type""")
    group.add_argument('-word_encoder_layers', type=int, default=1,
                       help='Number of layers in the encoder')
    group.add_argument('-sent_encoder_type', type=str, default='brnn',
                       choices=['rnn', 'brnn', 'mean', 'transformer', 'cnn'],
                       help="""hierarchical layer sent encode type""")
    group.add_argument('-sent_encoder_layers', type=int, default=1,
                       help='Number of layers in the encoder')
    group.add_argument('-question_init_type', type=str, default='rnn',
                       choices=['rnn', 'brnn', 'mean', 'transformer', 'cnn'],
                       help="""encoder question to initialize decoder""")
    group.add_argument('-question_init_layers', type=int, default=2,
                       help='Number of layers in the encoder')
    ...
    group.add_argument('-dec_rnn_size', type=int, default=500,
                       ...
                       speech-to-text.""")
    group.add_argument('-lambda_question', type=float, default=0.5,
                       help="""score hyperparam for question lambda""")
    group.add_argument('-lambda_answer', type=float, default=-1,
                       help="""score hyperparam for answer lambda""")
    ...
    # group.add_argument('-max_history_turns', type=int, default="2",
    #                    help="maximum number of turns in dialogue history")
...
def preprocess_opts(parser):
    ...
    group.add_argument('-train_dir', required=True,
                       help="Path to the training data")
    group.add_argument('-valid_dir', required=True,
    ...
    group.add_argument('-total_token_length', type=int, default=500,
                       help="Maximum source sequence length")
    group.add_argument('-src_seq_length', type=int, default=100,
                       help="Maximum source sequence length")
    group.add_argument('-src_sent_length', type=int, default=50,
                       help="Maximum source sequence length")
    ...
    group.add_argument('-feat_name', dest='feat_name', nargs='*', type=str,
                       default=[], help="Name of features for source")
...
def train_opts(parser):
    ...
    # GPU
    group.add_argument('-gpuid', default=0, type=int,
                       help="use which gpu, -1 for not use")
...
def translate_opts(parser):
    ...
    group = parser.add_argument_group('Data')
    group.add_argument('-data_type',
                       choices=["concat", "query", "hier"],
                       help="""concat: p <q> q <a> a <q> q <a> a <a> current_answer,
    ...
    group.add_argument('-target', default='gold.txt',
                       help="""Path to output the gold (each line will
                           be the decoded sequence""")
    ...
    group.add_argument('-max_test_sentences', type=int, default=12284,
                       help='Number of test sentences at a instance.')
    ...
    group.add_argument('-gpuid', default=-1, type=int,
                       help="use which gpu, -1 for not use")
    group.add_argument('-report_eval_every', default=50, type=int,
                       help="Report evalution score after every, default 50")
    group.add_argument('-feat_name', dest='feat_name', nargs='*', type=str,
                       default=[], help="Name of features for source")
